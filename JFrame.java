...
class NameGUI extends JFrame implements ActionListener{
    ...
    NameGUI(){
        ...
        JButton btnMikulsky = new JButton("Mikulsky");
        ...
        btnMikulsky.setActionCommand("Mikulsky");  
        btnMikulsky.addActionListener(this);
 
        //Add components to proper panels
        panelTop.add(btnSample);
        panelTop.add(btnQuit);
        
        panelMiddle.add(btnMikulsky);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
            case "Mikulsky": 
            	JOptionPane.showMessageDialog(this,"Kiersten Mikulsky","Dialog box",JOptionPane.PLAIN_MESSAGE);
            	break;
            case "Quit": 
            	System.exit(0);
                break;
