...
class NameGUI extends JFrame implements ActionListener{
    ...
    NameGUI(){
        ...
        JButton btnName = new JButton("Display/Show Name");
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            case "sample":
                ...
                break;
            case "name":
                JOptionPane.showMessageDialog(this,"Nathan Bailey","Nathan Bailey",JOptionPane.PLAIN_MESSAGE);
                break;
            case "quit" :
                System.exit(0);
                break;
            case "swap" :
                ...
                break;
            case "help" :
                JOptionPane.showMessageDialog(this,"There is no help for you.","Sorry not sorry",JOptionPane.WARNING_MESSAGE);
                break;
