...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton btnName	= new JButton("Name"); // My button
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
		case "bttn": 
		JOptionPane.showMessageDialog(this,"Najee Williams","My name is",JOptionPane.PLAIN_MESSAGE);
                break;
