...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton btnName = new JButton("Who?");
...
//added
	menuQuit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, Event.CTRL_MASK));
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
	    case "name" :
		JOptionPane.showMessageDialog(this, "Sydney Grace Hosfeld", "Creator of This Grand Button", JOptionPane.PLAIN_MESSAGE);
		break;
	    case "menuQuit" :
		System.exit(0);
		break;
