...
class NameGUI extends JFrame implements ActionListener{
	...
	btnName.setActionCommand("displayName");
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "swap" :
                ...
                break;
            case "help" :
                JOptionPane.showMessageDialog(this,"There is no help for you.","Sorry Mate",JOptionPane.WARNING_MESSAGE);
	    case "displayName" :
		JOptionPane.showMessageDialog(this,"Mark Hileman", "Message", JOptionPane.PLAIN_MESSAGE);
