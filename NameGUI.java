...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton btnName = new JButton("Message");
	...
	JMenuItem miFile = new JMenuItem("Quit File");
	miFile.addActionListener(this);
	miFile.setActionCommand("quit file");
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
	    case "name" :
		JOptionPane.showMessageDialog(this, "Alayna Marie Kelly", "Message", JOptionPane.PLAIN_MESSAGE);
		break;
	    case "quit file" :
		System.exit(0);
		break;
