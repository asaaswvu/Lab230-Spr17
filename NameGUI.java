...
class NameGUI extends JFrame implements ActionListener{
    ...
    NameGUI(){
        ...
        JButton btnSample = new JButton("What is my name?!?!?!");
        ...
        btnSample.setActionCommand("Eric Staffieri");  //yours will have to be unique
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            case "Eric Staffieri":
                JOptionPane.showMessageDialog(this,"Eric Staffieri","A plain message",JOptionPane.PLAIN_MESSAGE);
                break;
            case "quit" :
                System.exit(0);
                break;
