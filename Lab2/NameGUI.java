...
class NameGUI extends JFrame implements ActionListener{
	...
	JButton butname = new JButton("Get My Name");        
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (evt.getActionCommand()){
            ...
            case "help" :
                ...
                break;
            case "name" :
		JOptionPane.showMessageDialog(this, "DANTE CATACORA", "My name is", JOptionPane.PLAIN_MESSAGE);
		break;
        }
    }
...
>>>>>>> 62a3095bdf7544726b2b32f4c5f5cf37ee1897f5:NameGUI.java
